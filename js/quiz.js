const quizDatabase = {
    ...
    medium: [
      {
        ...
        options: ["1945-1949", "1825-1830", "1900-1905", "1800-1805"],
        answer: "1825-1830",
      },
      {
        question:
          "Gerakan Reformasi 1998 bertujuan untuk mengakhiri pemerintahan siapa?",
        options: ["BJ Habibie", "Gus Dur", "Soekarno", "Soeharto"],
        answer: "Soeharto",
      },
      {
      ...
      },
      {
        ...
        options: ["Jakarta", "Yogyakarta", "London", "Den Haag"],
        answer: "Den Haag",
      },
      {
      ...
      },
      {
        ...
        answer: "Melakukan kudeta terhadap pemerintah",
      },
    ],
    hard: [
      {
      ...
      },
      {
        ...
        options: ["Belanda", "Inggris", "Prancis", "Amerika Serikat"],
      ...
      },
      {
        ...
        options: ["Mataram Islam", "Pajang", "Demak", "Cirebon"],
        answer: "Demak",
      },
      {
      ...
      },
      {
        ...
        options: ["Portugis", "VOC", "Inggris", "Spanyol"],
        answer: "VOC",
      },
      {
        question:
      ...
      },
      {
        ...
        options: ["PKI", "Partai Demokrat", "Sarekat Dagang Islam", "PETA"],
        answer: "PETA",
      },
      {
        question: "Gerakan 30 September 1965 dipimpin oleh?",
        options: ["Soeharto", "Sukarno", "Syahrir", "DN Aidit"],
        answer: "DN Aidit",
      },
      {
    ...
    quizContent.innerHTML = `
      <div class="w-full max-w-md p-8 bg-white rounded-lg shadow-lg mx-auto">
        ...
        <div id="quizDifficultySelection" class="text-center">
          ...
          <button onclick="startSelectedQuiz()" class="w-full mt-4 p-3 text-white bg-gray-500 rounded-lg hover:bg-gray-600">
            Mulai Kuis
          </button>
        </div>
  ...
  function selectAnswer(selectedOption) {
    ...
    // Ketika Jawaban Telah Dipilih Akan Di Remove
